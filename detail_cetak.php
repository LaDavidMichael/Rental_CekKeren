...
<head>
	...
	<link href="assets/images/customer.png" rel="icon" type="images/x-icon">
		...
		<div class="container-fluid">
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td class="text-center">Jl. Banyu Urip Jaya Gg. III No.14, Putat Jaya, Kec. Sawahan, Kota SBY, Jawa Timur 60255 </td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
