...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Jan 2021 pada 08.14
...
('TRX00000', 10, '2021-02-01', 'Cancel'),
('TRX00000', 10, '2021-02-02', 'Cancel'),
('TRX00000', 10, '2021-02-03', 'Cancel'),
('TRX00000', 10, '2021-02-04', 'Cancel'),
('TRX00000', 11, '2021-02-01', 'Menunggu Pembayaran'),
('TRX00000', 11, '2021-02-02', 'Menunggu Pembayaran'),
('TRX00000', 11, '2021-02-03', 'Menunggu Pembayaran'),
('TRX00000', 11, '2021-02-04', 'Menunggu Pembayaran'),
('TRX00000', 11, '2021-02-05', 'Menunggu Pembayaran'),
('TRX00000', 10, '2021-02-05', 'Menunggu Pembayaran'),
('TRX00000', 10, '2021-02-06', 'Menunggu Pembayaran'),
('TRX00000', 10, '2021-02-07', 'Menunggu Pembayaran'),
('TRX00000', 11, '2021-02-06', 'Menunggu Pembayaran'),
('TRX00000', 11, '2021-02-07', 'Menunggu Pembayaran'),
('TRX00000', 11, '2021-02-08', 'Menunggu Pembayaran'),
('TRX00000', 11, '2021-02-09', 'Menunggu Pembayaran'),
('TRX00000', 11, '2021-02-10', 'Menunggu Pembayaran');
...
(3, 'Budi', 'budi@gmail.com', '087655433223', 'Vivamus posuere erat laoreet enim posuere finibus. Vivamus nec dictum risus. Etiam ac lorem rutrum, auctor lectus et, ullamcorper mauris. Duis convallis nibh urna, non auctor enim euismod vitae. Nunc at faucibus mi. Nam eu diam quis nisi rutrum porta ut non ligula. Aliquam a pharetra leo. Mauris venenatis dapibus erat sed rutrum.', '2021-01-28 00:46:46', NULL),
(4, 'Asep', 'asep@gmail.com', '089998765432', 'Etiam ut felis sed magna facilisis tempor. Vivamus ac justo aliquam, bibendum turpis at, sodales est. Fusce ullamcorper at lacus quis eleifend. Aenean eget congue risus. Proin in eleifend urna, a vestibulum urna. Quisque fringilla vulputate purus et blandit. Pellentesque at quam augue. Quisque condimentum porta ex, et feugiat nunc mollis at. Etiam sodales aliquam libero eu fermentum. Suspendisse vel orci in lorem mollis vehicula ut ut mauris.', '2021-01-28 00:47:17', NULL);
...
(1, 'Jl. Banyu Urip Jaya Gg. III No.14, Putat Jaya, Kec. Sawahan, Kota SBY, Jawa Timur 60255', 'cekkerencompany@gmail.com', '08573216606');
...
(5, 'Rekening', 'rekening', '																																	123456789 Bank BCA a/n Adams Klein Smith'),
...
(11, 'FAQs', 'faqs', '																																	<div style=\"text-align: justify;\"><span style=\"font-size: 1em; color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif;\">Q : Bagaimana cara menyewa mobil di&nbsp; CekKeren?</span></div><div style=\"text-align: justify;\"><span style=\"font-size: 1em; color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif;\">A : Pertama anda harus mendaftar terlebih dahulu sebagai user melalui menu yang telah disediakan.</span></div>																																	');
...
(7, 'Budi', 'budi@gmail.com', '9c5fa085ce256c7c598f6710584ab25d', '08887654987', 'Jl. Mahardika No.26', '28012021015043icon-contact.png', '28012021015043icon-passport.png', '2021-01-28 00:50:43', NULL);
